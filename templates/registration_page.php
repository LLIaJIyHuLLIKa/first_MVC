...
<html>
	<head>
		...
		<title>Процесс регистрации</title>
		...
		<div class="container" style="background-color: white">
			...
			<div class="row">
				<div class="col-md-12 text-center">
				    <?php
				        if($fullName != null && $login != null && $email != null && $password != null) {
					        echo '<h5>Вы успешно зарегистрированы! <a href="./">Вернуться на главную</a></h5>';
				        }
				        else {
				            echo '<h5>Ошибка регистрации! <a href="./">Вернуться на главную</a></h5>';
				        }
				    ?>
				</div>
			</div>
