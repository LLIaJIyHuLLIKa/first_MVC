				...
				<div class="col-md-12">
					<?php
						if(is_array($data) || is_object($data)) {
							if(count($data) == 0) {
								echo '<p class="text-center">По вашему запросу ничего не найдено</p>';
							}
							else {
								foreach($data as $row) {
					?>
									<div class="film">
										<img src="<?php echo $row['poster']; ?>"</img>
									<p>Название: <span class="film__info"><?php echo $row['title']; ?></span></p>
									<p>Год: <span class="film__info"><?php echo $row['year']; ?></span></p>
									<p>Актеры: <span class="film__info"><?php echo $row['film_actors']; ?></span></p>
									<p>Компания: <span class="film__info"><?php echo $row['company']; ?></span></p>
									<p>Жанр: <span class="film__info"><?php echo $row['genre']; ?></span></p>
									<p>Описание:</p>
